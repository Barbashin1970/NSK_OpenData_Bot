...
const modulesData = [
  {
    ...
    fullTitle: "Модуль 1. Основы промпт-инжиниринга",
    maxScore: 12,
    questions: [
      {
        id: 1,
    ...
    questions: [
      ...
      },
      {
        ...
        items: [
          ...
          { number: "2", text: "Модели 13B и выше (например, Llama 3.3 70B)", correct: "А" },
          { number: "3", text: "Облачные модели (например, GigaChat)", correct: "В" }
        ],
        rightOptions: [
          ...
          { letter: "В", text: "Сотни миллиардов параметров, максимальное качество, но данные уходят на сервер — не подходят для конфиденциальной информации" }
        ]
      }
    ]
  },
  {
    ...
    fullTitle: "Модуль 6. Вайб-кодинг для автоматизации",
    maxScore: 12,
    questions: [
      {
        id: 26,
