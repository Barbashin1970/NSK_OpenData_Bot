...
DISTRICTS: dict[str, list[str]] = get_districts()
_SUB_DISTRICTS: list[tuple[re.Pattern, str, str]] = get_sub_districts_compiled()
SUB_DISTRICTS_INFO: dict[str, tuple[str, list[str]]] = get_sub_districts_info()
...
_MEDICAL_PRIMARY = [
    ...
    "хирург", "инфекцион", "онколог", "амбулатор", "здравоохран",
    "лечебн", "врач", "лечени", "госпитал",
]
_MEDICAL_KEYWORDS = [
    "больниц",
    "поликлиник",
