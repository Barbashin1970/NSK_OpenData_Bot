...
_SUB_DISTRICTS: list[tuple[re.Pattern, str, str]] = [
    # ── Советский район ─────────────────────────────────────────────────────
    # Академгородок: «в Академгородке», «академгородок», «Academ», «в Академе»
    (re.compile(r"академгородк"),                         "Советский район", "Академгородок"),
    (re.compile(r"(?<![а-яё])academ", re.IGNORECASE),    "Советский район", "Академгородок"),
    (re.compile(r"(?<![а-яё])академе(?![а-яё])"),        "Советский район", "Академгородок"),
...
SUB_DISTRICTS_INFO: dict[str, tuple[str, list[str]]] = {
    "Академгородок": ("Советский район", ["академгородок", "academ", "в Академе"]),
