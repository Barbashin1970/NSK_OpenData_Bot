...
async def _seed_task_space() -> None:
    ...
    try:
        ...
        from .task_store import seed_initiatives, seed_users
        ...
        # Строительные компании (из opendata, если данные уже закешированы)
...
async def _start_background_preloader() -> None:
    ...
    import asyncio
    from .updater import (
        preload_all_async, periodic_refresh_loop,
        multi_city_refresh_loop, critical_data_refresh_loop,
    )
